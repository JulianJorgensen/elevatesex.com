        ...
        <section className="section">
          <div className="row">
            <div className="small-12 medium-6 columns">
              <p className="lead">Happy couples, passionate couples, new couples, old couples. Unhappy couples, distant couples, inexperienced couples and seasoned couples. We welcome all of you.</p>
