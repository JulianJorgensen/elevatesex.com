          ...
          <div className="row">
            <div className="small-12 medium-6 columns">
              <div className="bio bio-first">
                ...
                {/* <p className="lead">In traditional Chinese families, sex was more of an obligation to reproducing children than to experience pleasure or connectedness with your lover. Nevertheless transform one's life. Jocelyn was born into these beliefs, even though she grew up in Canadian culture, and it set her up for years of confusion in her sex and love life.</p>
                <ReadMore>
                  <p>Everything from early masturbation to regular drunk sex, manipulation of men to being walked all over, slutty sex to scratching the itch. Sex became a means to an end.</p>
            ...
            <div className="small-12 medium-6 columns">
              <div className="bio">
                ...
                <p className="lead">Attracting woman was never a problem. The problem was behind closed doors. I felt they were never fully satisfied sexually. The music choice was right. The timing was right. I was confident about my look and body. Everything was perfect. Except for one thing. It all boiled down to my magical 20 minutes. That’s about the length of time I could last in bed. Then I ejaculated and the show was over. Good night.</p>
                <ReadMore>
                  <p>This pattern contributed to my girlfriends’ lack of peacefulness (or whatever you want to call that juice satisfied state).</p>
                  <p>In my early 20s I was fortunate to be introduced to the teachings of the Indian mystic OSHO. This profound turning point changed my life. It was the beginning of my interest in Tantra.<br />
                  Opposite many people, I was not very interested in sex in my teenage years and early 20s. I was busy learning about life and exploring many spiritual depths. Tantra challenged this belief and I slowly started realizing the vast potential there was in epic sex. <br />
                  Despite many spiritual revelations, I was still a *quickie* in bed. The magical 20 minutes was now more magical, but short nonetheless. I tried everything from Yoga, standing on my head, pranayama (breath work), Maca, to weight lifting and beyond. Nothing seemed to truly work.</p>
                  <p>In my mid 20s I was introduced to the teachings of David Deida. His student Satyen Raja became my mentor and that was another big turning point. Unlike my past experience with Tantra, this had a lot more of a masculine quality. It was a 2-piece puzzle coming together. Feminine and Masculine. I become soft yet penetrating.</p>
